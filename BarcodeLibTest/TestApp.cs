...
namespace BarcodeLibTest
{
    public partial class TestApp : Form
    {
        ...
        public Image ParaOutImg;
        public string ParaInNumber;
        private void btnEncode_Click(object sender, EventArgs e)
        {
            errorProvider1.Clear();
            int W = Convert.ToInt32(this.txtWidth.Text.Trim()) + 100;
            ...
            {
                // case "UPC-A": type = BarcodeLib.TYPE.UPCA;
                case "UPC-A": type = BarcodeLib.TYPE.CODE128; break;
            ...
            try
            {
                if (type != BarcodeLib.TYPE.UNSPECIFIED)
                {
                    ...
                    ParaOutImg = b.Encode(type, this.txtData.Text.Trim(), this.btnForeColor.BackColor, this.btnBackColor.BackColor, W, H);
                    barcode.Image = ParaOutImg;
                    //===================================
        ...
        public Image CallLabel(string Number)
        {
            txtData.Text = Number;
