...
namespace Accounts.Forms
{
    ...
    public class TNumEditDataGridViewColumn : DataGridViewTextBoxColumn
    {
        ...
        {
            TNumEditDataGridViewCell cell = new TNumEditDataGridViewCell(2);
    ...
    {
        private bool m_showNullWhenZero = true ;
        private bool m_allowNegative = true;
        private int m_decimalLength = 2;
        ...
        public TNumEditDataGridViewCell(int decimalLength)
        {
